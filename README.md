...
- [docs/local-draft-pipeline.md](docs/local-draft-pipeline.md) — Claude Code runbook: repurpose a bookmarked video into draft posts on another gallery/account, conversationally
